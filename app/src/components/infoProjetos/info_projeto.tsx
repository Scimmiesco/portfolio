...
export default function InfoProjetos() {
  ...
  return (
    <section className="relative infoSection">
      ...
      <div className={` ${modalFechado ?
        'opacity-0 h-0 w-0'
        : 'opacity-95 '} modal absolute bg-white border-2 border-dark w-64 h-96 white top-0 right-10 z-40 rounded-3xl m-2 shadow-sm shadow-dark`}>
         ...
         ${modalFechado ?
          ...
          <ul>
            ...
            <li>
              ...
              <a className='' href='https://v15.material.angular.io/' target='blank'><p className='px-3'>Angular Material</p></a>
              <a href='https://swiperjs.com/swiper-api' target='blank'><p className='px-3'>SwiperJS</p></a>
              <a href='https://www.npmjs.com/package/crypto-js' target='blank'><p className='px-3'>Crypto-Js</p></a>
              <a href='https://www.npmjs.com/package/jwt-decode' target='blank'><p className='px-3'>JWT-Decode</p></a>
              <a href='https://ngrx.io/guide/store' target='blank'><p className='px-3'>Ngrx-Store</p></a>
            </li>
          </ul>
        </nav>
      </div>
